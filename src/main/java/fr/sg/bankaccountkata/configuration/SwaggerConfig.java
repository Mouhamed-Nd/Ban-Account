...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .build()
                .tags(new Tag(BANK_ACCOUNT, "Effectuez des retraits et des dépôts, obtenez votre solde et consultez l'historique de vos opérations depuis votre compte bancaire."));
